// =========================================================
// Ejercicio 3 — Pareo de fotos | Clase 1: El origen del universo y
// del sistema solar | Ciencias Naturales 9° | C.E.B.G. EL JIRAL
// =========================================================
// Igual que el Ejercicio 2 (pareo de términos), pero con fotos: de
// las 32 fotos del banco (BANCO_FOTOS_CLASE1), se toman 8 al azar,
...
const BANCO = window.BANCO_FOTOS_CLASE1;
...
document.getElementById("btn-revisar-fotos").addEventListener("click", async () => {
  ...
  window.guardarIntentoPracticaSeguro(sb, T.intentosPractica, payloadFotos).catch(() => {});
});
