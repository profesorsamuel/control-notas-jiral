// =========================================================
// CONFIGURACIÓN — Examen Clase 2: La vida en la Tierra, la historia
// geológica y la exploración del universo
...
window.PRUEBA_CONFIG = {
  ...
  grado: "9°",
  tituloExamen: "Examen Clase 2: La vida en la Tierra y la exploración del universo",
  ...
  // en una sola hoja).
  nombreActividad: "Clase 2",
  escuela: "C.E.B.G. EL JIRAL",
  codigoExamen: "cn9-clase2-vida-tierra-2026", // clave única en Supabase para este examen
  bancoGlobal: "BANCO_CLASE2_CIENCIAS_9",
  paginaExamen: "prueba_clase2_ciencias_9.html",
  ...
  fechaLimiteInscripcion: "2026-10-08T23:59:59-05:00",
  ...
  // PRÁCTICA (ver prueba_clase2_ciencias_9.html), igual que la Clase 1, así
  // que estas fechas ya no se usan para bloquear nada, pero se dejan
  // definidas por si en el futuro se vuelve a activar el examen oficial.
  fechaInicio: "2026-10-05T09:00:00-05:00",
  fechaLimiteAcceso: "2026-10-08T23:59:59-05:00",
  // Hora de cierre total de los 3 ejercicios de esta clase (Quiz, Pareo
  // de términos y Pareo de fotos): jueves 8 de octubre a las 11:59 p.m.
  ...
  fechaCierreTotal: "2026-10-08T23:59:59-05:00",
