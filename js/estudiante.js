...
<head>
    ...
    <style>
        * {
        ...
        .btn-toggle-seccion[aria-pressed="true"] {
            background: #1f4e79;
            color: white;
        }
...
<body>
    ...
    <div class="acciones-superiores">
        ...
        <a href="horario_semanal.html" class="btn-accion">
            📅 Horario semanal
        </a>

        <a href="mis_tareas.html" class="btn-accion" id="enlaceMisTareas">
            📝 Mis tareas
        </a>
    </div>
    ...
    <div class="filtro-secciones">
        <button type="button" id="btnToggleApreciacion" class="btn-toggle-seccion" aria-pressed="false">
            🙈 Ocultar Apreciación
        </button>
        <button type="button" id="btnToggleEjercicio" class="btn-toggle-seccion" aria-pressed="false">
            🙈 Ocultar Ejercicio
        </button>
        <button type="button" id="btnToggleExamen" class="btn-toggle-seccion" aria-pressed="false">
            🙈 Ocultar Examen
        </button>
    </div>
    ...
    <!-- Insignia de tareas pendientes sobre "Mis tareas" -->
    <script type="module" src="../js/panel_estudiante_avisos.js"></script>
